...
#
# Generated by export_simulation on Sun Nov 04 02:22:46 CST 2018
#
################################################################################
...
switch to the './SimpleModule_0.sh' script.

./SimpleModule_0.sh -reset_run
...
./SimpleModule_0.sh -noclean_files

For more information on the script, please type './SimpleModule_0.sh -help'.
